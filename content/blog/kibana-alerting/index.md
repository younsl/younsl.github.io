...
AWS OpenSearch Service의 [Features by engine version](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/features-by-version.html) 문서에 따르면, Alerting 기능 지원 버전은 다음과 같습니다:

| Feature | 엔진 | 최소 버전 |
|---------|------|-----------|
| Alerting | Elasticsearch OSS | 6.2 |
| Alerting | OpenSearch | 1.0 |
