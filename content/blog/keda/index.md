...
HPA가 적용된 Deployment나 Rollout의 스펙에 파드 개수(.spec.replicas)를 설정하는 것은 권장되지 않습니다. 해당 필드는 서로 다른 컨트롤러에서 사용되기 때문입니다.
...
spec:
  # If KEDA is enabled, the replicas will be managed by HPA.
