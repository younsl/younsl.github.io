...
| Policy Type | Version | State |
|-------------|---------|-------|
| [ValidatingAdmissionPolicy](https://kubernetes.io/docs/reference/access-authn-authz/validating-admission-policy/) | 1.30+ | Stable |
| [MutatingAdmissionPolicy](https://kubernetes.io/docs/reference/access-authn-authz/mutating-admission-policy/) | 1.34+ | Beta |

이 글에서는 ValidatingAdmissionPolicy (VAP)를 사용하여 특정 사용자의 권한을 제한하는 방법을 다룹니다.
...
![SessionName 패턴과 사용자별 권한 제어](1.png)
