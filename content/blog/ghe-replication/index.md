...
- [이중화 구성](#이중화-구성)
  - [서버 접속](#서버-접속)
    - [서버 접속 시 참고할 문서](#서버-접속-시-참고할-문서)
  - [복제용 키페어 생성](#복제용-키페어-생성)
  - [복제용 키페어 등록](#복제용-키페어-등록)
  - [Replica 등록](#replica-등록)
    - [명령어 형식](#명령어-형식)
    - [명령어 예시](#명령어-예시)
  - [복제 시작](#복제-시작)
  - [이중화 상태 확인](#이중화-상태-확인)
  - [결과 확인](#결과-확인)
- [이중화 해제](#이중화-해제)
  - [Replica 서버 접속](#replica-서버-접속)
  - [이중화 상태 체크](#이중화-상태-체크)
  - [이중화 중지](#이중화-중지)
  - [이중화 해제하기](#이중화-해제하기)
  - [인스턴스 중지](#인스턴스-중지)
- [참고자료](#참고자료)
  - [이중화 구성 관련 참고자료](#이중화-구성-관련-참고자료)
  - [이중화 해제 관련 참고자료](#이중화-해제-관련-참고자료)
