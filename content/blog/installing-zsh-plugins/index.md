...
- [준비사항](#준비사항)
  - [로컬 환경](#로컬-환경)
- [유용한 터미널 플러그인들](#유용한-터미널-플러그인들)
  - [autojump](#autojump)
    - [(1) brew 설치 목록 확인](#1-brew-설치-목록-확인)
    - [(2) 설치](#2-설치)
    - [(3) 플러그인 추가](#3-플러그인-추가)
    - [(4) 적용](#4-적용)
    - [(5) 동작 테스트](#5-동작-테스트)
  - [2. neofetch](#2-neofetch)
    - [(1) brew 설치 목록 확인](#1-brew-설치-목록-확인-1)
    - [(2) brew 검색](#2-brew-검색)
    - [(3) neofetch 설치](#3-neofetch-설치)
    - [(4) 적용](#4-적용-1)
    - [(5) 결과확인](#5-결과확인)
- [더 나아가서](#더-나아가서)
  - [neofetch 커스텀 이미지](#neofetch-커스텀-이미지)
  - [랜덤 명언 조합하기](#랜덤-명언-조합하기)
- [마치며](#마치며)
