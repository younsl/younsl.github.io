...
Github Cloud에 공개되어 있는 [커밋 로그 초기화를 위한 스크립트](https://github.com/younsl/bucket/blob/main/bucket/script/github/commit-history-cleaner.sh)<sup>`commit-history-cleaner.sh`</sup>를 다운로드 받습니다.

```bash
wget -O commit-history-cleaner.sh \
  https://raw.githubusercontent.com/younsl/bucket/main/bucket/script/github/commit-history-cleaner.sh
```
...
**Github**  
[commit log 초기화 스크립트](https://github.com/younsl/bucket/blob/main/bucket/script/github/commit-history-cleaner.sh)
