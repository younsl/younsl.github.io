...
Actions Runner가 testcontainers에서 사용하는 이미지 2개를 actions cache로 바로 받아오는 경우 아래와 같이 총 테스트 빌드 시간이 단축됨

- 케이스 1 (mysql, valkey 이미지): 6분 10초 -> 3분 14초
- 케이스 2 (mysql, valkey 이미지): 6분 10초 -> 3분 7초
