...
- [배경지식](#배경지식)
  ...
  - [설치 가능한 클러스터 환경](#설치-가능한-클러스터-환경)
  - [kube-green이 제어하는 리소스](#kube-green이-제어하는-리소스)
  - [사용 예시](#사용-예시)
    - [평일 근무시간에만 dev 클러스터 운영하기](#평일-근무시간에만-dev-클러스터-운영하기)
- [환경](#환경)
  - [쿠버네티스 클러스터 환경](#쿠버네티스-클러스터-환경)
  - [로컬 환경](#로컬-환경)
- [설치하기](#설치하기)
  - [설치과정 요약](#설치과정-요약)
    - [설치방식](#설치방식)
    - [쿠버네티스 오퍼레이터의 이점](#쿠버네티스-오퍼레이터의-이점)
  - [OLM 설치](#olm-설치)
  - [cert-manager 설치](#cert-manager-설치)
  - [kube-green 설치](#kube-green-설치)
- [구성하기](#구성하기)
- [더 나아가서](#더-나아가서)
  - [kube-green으로 비용 절감하기](#kube-green으로-비용-절감하기)
  - [Karpenter와 조합하기](#karpenter와-조합하기)
