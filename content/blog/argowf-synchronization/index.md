...
keywords: []
tags: ["devops", "kubernetes", "argo-workflows", "workflow", "synchronization", "concurrency", "mutex", "cron"]
---
...
![CR과 Argo Workflows Server의 관계도](./1.png)

위 다이어그램은 In-cluster 구성에서 Argo Workflows Server가 동일한 Kubernetes 클러스터 내의 커스텀 리소스(CR)들을 처리하는 과정을 보여줍니다. CronWorkflow가 WorkflowTemplate을 참조하여 주기적으로 Workflow를 생성하고, 최종적으로 Pod가 실행됩니다.
...
![Waiting workflow due to locking](./2.png)
