...
{{/*
Merge common annotations with resource-specific annotations
Usage: {{ include "squid.mergedAnnotations" (dict "common" .Values.commonAnnotations "resource" .Values.service.annotations) }}
*/}}
{{- define "squid.mergedAnnotations" -}}
{{- $common := .common | default dict }}
{{- $resource := .resource | default dict }}
{{- $merged := merge $resource $common }}
{{- if $merged }}
{{- toYaml $merged }}
{{- end }}
{{- end }}